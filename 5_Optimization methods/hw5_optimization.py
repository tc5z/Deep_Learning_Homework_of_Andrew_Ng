...
def model(X, Y, layers_dims, optimizer, learning_rate=0.0007,
          ...
          epsilon=1e-8, num_epochs=10001, print_cost=True, is_plot=True):
    """
...
# parameters = model(train_X, train_Y, layers_dims, optimizer="gd", is_plot=True)  # 使用普通的梯度下降
# parameters = model(train_X, train_Y, layers_dims, beta=0.9, optimizer="momentum", is_plot=True)  # 使用动量的梯度下降
parameters = model(train_X, train_Y, layers_dims, optimizer="adam", is_plot=True)  # 使用Adam优化的梯度下降

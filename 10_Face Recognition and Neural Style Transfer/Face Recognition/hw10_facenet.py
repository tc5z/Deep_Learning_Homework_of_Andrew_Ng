...
database = {"danielle": fr_utils.img_to_encoding("images/danielle.png", FRmodel),
            "younes": fr_utils.img_to_encoding("images/younes.jpg", FRmodel),
            "tian": fr_utils.img_to_encoding("images/tian.jpg", FRmodel),
            "andrew": fr_utils.img_to_encoding("images/andrew.jpg", FRmodel),
            "kian": fr_utils.img_to_encoding("images/kian.jpg", FRmodel),
            "dan": fr_utils.img_to_encoding("images/dan.jpg", FRmodel),
            "sebastiano": fr_utils.img_to_encoding("images/sebastiano.jpg", FRmodel),
            "bertrand": fr_utils.img_to_encoding("images/bertrand.jpg", FRmodel),
            "kevin": fr_utils.img_to_encoding("images/kevin.jpg", FRmodel),
            "felix": fr_utils.img_to_encoding("images/felix.jpg", FRmodel),
            "benoit": fr_utils.img_to_encoding("images/benoit.jpg", FRmodel),
            "arnaud": fr_utils.img_to_encoding("images/arnaud.jpg", FRmodel)}

'''
# 人脸验证
dist, is_door_open = verify("images/camera_0.jpg", "younes", database, FRmodel)
print(dist, is_door_open)
dist, is_door_open = verify("images/camera_2.jpg", "kian", database, FRmodel)
print(dist, is_door_open)
'''
# 人脸识别
